...
/* ─────────────────────────────────────────────────────────
 * TASK ROWS
 * Rows enter staggered; a ring spinner works, one row
 * fails and retries, then everything resolves. The status
 * run completes once; task details stay clickable.
 * ───────────────────────────────────────────────────────── */
      ...
      {rows.map((row, i) => {
        ...
        return (
          ...
          >
            ...
            {/* dropdown detail — same expandable grammar as the thinking trace */}
            <div
