...
const CLI_COMMAND = "curl -fsSL https://raw.githubusercontent.com/reshardhq/reshard/main/install.sh | sh";
    ...
    <main className="min-h-screen overflow-hidden bg-[#08090b] text-white">
      <nav className="border-b border-white/10">
        <div className="mx-auto flex h-14 max-w-7xl items-center border-x border-white/10 px-5">
          <a href="#" className="flex items-center gap-2.5"><Mark /><span className="text-[15px] font-bold tracking-[-0.03em]">reshard</span></a>
          <div className="ml-auto flex items-center gap-2 sm:gap-5">
            ...
            <Button asChild variant="ghost" size="sm"><a href="https://github.com/reshardhq/reshard"><GitBranch />GitHub</a></Button>
      ...
      <section className="relative mx-auto max-w-7xl border-x border-white/10">
        ...
        <div className="relative z-10 flex min-h-[620px] flex-col items-center px-5 pb-16 pt-20 text-center sm:pt-28">
          ...
          <div id="download" className="mt-9 flex flex-col items-center gap-3">
            <Button asChild size="lg" className="min-w-[230px] font-semibold shadow-[0_12px_45px_rgba(139,164,255,.15)]"><a href="https://github.com/reshardhq/reshard/releases/latest/download/Reshard-aarch64-apple-darwin.dmg"><MonitorDown />Download for macOS</a></Button>
            <div className="flex items-center gap-3 font-mono text-[9px] uppercase tracking-[0.1em] text-white/30"><span>Apple silicon</span><span className="size-0.5 rounded-full bg-white/25" /><a className="underline decoration-white/20 underline-offset-4 hover:text-white/60" href="https://github.com/reshardhq/reshard/releases/latest/download/Reshard-x86_64-apple-darwin.dmg">Intel Mac</a></div>
          </div>
          <a href="#preview" aria-label="See Reshard" className="mt-auto pt-16 text-white/25 transition-colors hover:text-white"><ArrowDown className="size-4" /></a>
        </div>
      ...
      <section id="remote" className="border-t border-white/10">
        <div className="mx-auto grid max-w-7xl border-x border-white/10 lg:grid-cols-[.75fr_1.25fr]">
          <div className="border-b border-white/10 p-7 lg:border-b-0 lg:border-r lg:p-12"><div className="font-mono text-[10px] uppercase tracking-[0.14em] text-[#8ba4ff]">Remote machines</div><h2 className="mt-5 text-3xl font-bold tracking-[-0.05em]">Your VPS is one command away.</h2><p className="mt-4 max-w-[380px] text-xs leading-6 text-white/42">Install the lightweight CLI remotely. Then open Reshard, generate a pairing code, and paste it into that terminal once.</p></div>
          <div className="flex flex-col justify-center gap-4 p-7 lg:p-12"><div><div className="mb-2 font-mono text-[9px] uppercase tracking-[0.12em] text-white/30">1 · Install on the remote machine</div><CopyCommand command={CLI_COMMAND} /></div><div className="grid grid-cols-[1fr_auto] items-center gap-4 border border-dashed border-white/12 px-4 py-3"><div><div className="font-mono text-[9px] uppercase tracking-[0.12em] text-white/30">2 · Paste the code shown in the app</div><code className="mt-2 block font-mono text-[11px] text-white/60">reshard pair RP-XXXX-XXXX</code></div><span className="font-mono text-[8px] uppercase tracking-[0.1em] text-white/20">one time</span></div></div>
        </div>
      </section>

      <div className="h-12 border-y border-white/10"><div className="h-full border-x border-white/10 hatch mx-auto max-w-7xl" /></div>
      <footer><div className="mx-auto flex h-20 max-w-7xl items-center border-x border-white/10 px-5"><a href="#" className="flex items-center gap-2"><Mark /><span className="text-sm font-bold">reshard</span></a><span className="ml-auto font-mono text-[9px] uppercase tracking-[0.12em] text-white/25">Your agents, within reach.</span></div></footer>
    </main>
  );
}
